              ...
              <div className="card-body p-5">
                <div className="text-center mb-5">
                  ...
                  <p className="mb-4" style={{ 
                    ...
                    Create your account to start discovering signals
                  </p>
                </div>
                ...
                <form onSubmit={handleSubmit}>
                  <div className="mb-4">
                    <label htmlFor="name" className="form-label fw-semibold" style={{ color: '#374151', fontSize: '0.875rem' }}>
                      Name (Optional)
                    </label>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="form-text" style={{ color: '#6b7280', fontSize: '0.75rem', marginTop: '0.5rem' }}>
